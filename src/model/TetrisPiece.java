...
public enum TetrisPiece {
     ...
     * The 'L' TetrisPiece.
     */
    L(3, 2, Color.ORANGE, new Point(2, 2), new Point(0, 1), new Point(1, 1), new Point(2, 1)),

    /**
     * The 'O' TetrisPiece.
     */
    O(2, 2, Color.YELLOW, new Point(1, 2), new Point(2, 2), new Point(1, 1), new Point(2, 1)),
     ...
     * The 'T' TetrisPiece.
     */
    T(3, 2, Color.MAGENTA, new Point(1, 2), new Point(0, 1), new Point(1, 1), new Point(2, 1)),
